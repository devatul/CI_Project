                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="header">
                                ...
                                <p class="category"><a href="<?php echo base_url('admin/addtestpaper');?>"class="btn btn-primary btn-fill pull-right">Add a Test Paper</a></p>
                            </div>
                            <div class="content">
												...
												foreach($paper as $x)
												{
													?>
														<tr>
															...
															<td>
																<a href="<?php echo base_url('admin/paperdetails/'.$x['paper_id']);?>" class="btn btn-info btn-block">Details</a><br>
