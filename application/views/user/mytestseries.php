							...
							<?php
								if(count($free))
								{
									...
									<tr>
										...
										<th>
											<a href="<?php echo site_url('Test/viewpapers/'.$x['series_slug']);?>" style="border-radius:0px;" class="btn btn-warning btn-fill btn-block">View All Tests <i class="fa fa-chevron-right" aria-hidden="true"></i></a><br>
 										</th>
									</tr>
									<?php
									}
